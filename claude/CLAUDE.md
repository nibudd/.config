...
- **In drive mode, two things are on you regardless of gates:**
  1. **The worklog** (`<repo>/.claude/<branch>/worklog.md`, under `## Decisions`) — one line per non-obvious choice: what you chose, what you rejected, why, *including* the ones you didn't stop for. It's my review surface for ungated work. Skip it for pure boilerplate.
